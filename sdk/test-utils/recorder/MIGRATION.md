...
| `unit-test:node`           | `mocha -r esm -r ts-node/register --reporter ../../../eng/tools/mocha-multi-reporter.js --timeout 1200000 --full-trace --exclude \"test/**/browser/*.spec.ts\" \"test/**/*.spec.ts\"` | `dev-tool run test:node-ts-input -- --timeout 1200000 --exclude 'test/**/browser/*.spec.ts' 'test/**/*.spec.ts'` |
| `integration-test:browser` | `karma start --single-run`                                                                                                                                                               | `dev-tool run test:browser`                                                                                      |
| `integration-test:node`    | `nyc mocha -r esm --require source-map-support/register --reporter ../../../eng/tools/mocha-multi-reporter.js --timeout 5000000 \"dist-esm/test/{,!(browser)/**/}*.spec.js\"`         | `dev-tool run test:node-js-input -- --timeout 5000000 'dist-esm/test/**/*.spec.js'`                              |
