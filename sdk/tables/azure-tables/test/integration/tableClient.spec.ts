...
describe("TableClient", () => {
  ...
  describe("createEntity", () => {
    ...
    it("should createEntity with Guid", async () => {
      const testGuid: Edm<"Guid"> = {  value: "cf8ef051-1b7d-4e93-a1e5-a3944d7e441c", type: "Guid" };
    ...
    it("should createEntity with Int64", async () => {
      const testInt64: Edm<"Int64"> = {  value: "12345543221", type: "Int64" };
    ...
    it("should createEntity with Boolean", async () => {
      ...
      const testEntity: TableEntity<{ testBoolean: Edm<"Boolean"> | boolean }> = {
        PartitionKey: "P2",
        RowKey: "R2",
        testBoolean
      };
    ...
    it("should createEntity with DateTime", async () => {
      const testDate = new Date(2020, 8, 17);
      const testDateTime: Edm<"DateTime"> = {  value: testDate, type: "DateTime" };
      // Check this API interaction!
      const testEntity: TableEntity<{ testDateTime: Edm<"DateTime"> | Date }> = {
        PartitionKey: "P2",
        RowKey: "R2",
        testDateTime
      };
