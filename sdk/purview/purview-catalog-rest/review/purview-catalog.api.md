...
// @public (undocumented)
export type DictionaryOfString = {
    [key: string]: string;
};
...
// @public (undocumented)
export type JsonAtlasAttributeDefOptions = {
    [key: string]: string;
};
...
// @public (undocumented)
export type JsonAtlasBaseTypeDefOptions = {
    [key: string]: string;
};
...
// @public (undocumented)
export type JsonAtlasClassificationSourceDetails = {
    [key: string]: any;
};
...
// @public (undocumented)
export type JsonAtlasConstraintDefParams = {
    [key: string]: any;
};
...
// @public (undocumented)
export type JsonAtlasEntityContacts = {
...
// @public (undocumented)
export type JsonAtlasEntityRelationshipAttributes = {
    [key: string]: any;
};

// @public (undocumented)
export type JsonAtlasEntitySourceDetails = {
    [key: string]: any;
};
...
// @public (undocumented)
export type JsonAtlasLineageInfoExtraProperties = {
    [key: string]: any;
};
...
// @public (undocumented)
export type JsonAtlasObjectIdUniqueAttributes = {
    [key: string]: any;
};
...
// @public (undocumented)
export type JsonAtlasStructAttributes = {
    [key: string]: any;
};
...
// @public (undocumented)
export type JsonSearchFilterParams = {
    [key: string]: string[];
};
...
// @public (undocumented)
export type JsonTermCustomAttributesExtraProperties = {
    [key: string]: any;
};
...
// @public (undocumented)
function PurviewCatalog_2(accountName: string, credentials: TokenCredential | KeyCredential, options?: ClientOptions): PurviewCatalog;

export default PurviewCatalog_2;

// @public (undocumented)
export interface PurviewCatalogFactory {
    // (undocumented)
    (accountName: string, credentials: TokenCredential | KeyCredential, options?: ClientOptions): void;
}
