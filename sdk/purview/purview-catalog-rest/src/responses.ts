...
export interface GlossaryRestGetRelatedCategories200Response
  extends HttpResponse {
  status: "200";
  body: DictionaryOfpathsCic80AAtlasV2GlossaryCategoryCategoryguidRelatedGetResponses200ContentApplicationJsonSchemaAdditionalproperties;
}
...
export interface GlossaryRestGetRelatedTerms200Response extends HttpResponse {
  status: "200";
  body: DictionaryOfpathsV84KwqAtlasV2GlossaryTermsTermguidRelatedGetResponses200ContentApplicationJsonSchemaAdditionalproperties;
}
