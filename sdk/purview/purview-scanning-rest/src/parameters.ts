...
export type FiltersCreateOrUpdateParameters = RequestParameters &
...
export type FiltersListByScanParameters = RequestParameters &
  FiltersListByScanQueryParam;
...
export type ScansListHistoryParameters = RequestParameters &
  ScansListHistoryQueryParam;
...
export type ScansListHistoryPostParameters = RequestParameters &
  ScansListHistoryPostQueryParam;

export interface ScansCreateOrUpdateBodyParam {
  body: Scan;
}

export type ScansCreateOrUpdateParameters = RequestParameters &
...
export type ScansListByDataSourceParameters = RequestParameters &
  ScansListByDataSourceQueryParam;
...
export type TriggersCreateTriggerParameters = RequestParameters &
...
export type TriggersListByScanParameters = RequestParameters &
  TriggersListByScanQueryParam;
