...
export interface AzureKeyVaultsGetAzureKeyVault200Response
...
/** Gets azureKeyVault information */
export interface AzureKeyVaultsGetAzureKeyVaultdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorResponseModel;
}
...
export interface AzureKeyVaultsCreateAzureKeyVault200Response
  extends HttpResponse {
  status: "200";
  body: AzureKeyVault;
}
...
/** Creates an instance of a azureKeyVault */
export interface AzureKeyVaultsCreateAzureKeyVaultdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorResponseModel;
}
...
export interface AzureKeyVaultsDeleteAzureKeyVault200Response
  extends HttpResponse {
  status: "200";
}

/** Deletes the azureKeyVault associated with the account */
export interface AzureKeyVaultsDeleteAzureKeyVaultdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorResponseModel;
}
...
/** List azureKeyVaults in account */
export interface AzureKeyVaultsListByAccountdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorResponseModel;
}
...
export interface DataSourcesListChildrenByCollection200Response
  extends HttpResponse {
  status: "200";
  body: DataSourceList;
}
...
/** Lists the children of the collection. */
export interface DataSourcesListChildrenByCollectiondefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorResponseModel;
}
...
export interface DataSourceListUnparentedDataSourcesByAccount200Response
  extends HttpResponse {
  status: "200";
  body: DataSourceList;
}
...
/** Lists the data sources in the account that do not belong to any collection. */
export interface DataSourceListUnparentedDataSourcesByAccountdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorResponseModel;
}
...
/** Get a system scan ruleset settings for a data source */
export interface SystemScanRulesetSettingsGetdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorResponseModel;
}
...
export interface SystemScanRulesetSettingsListAll200Response
  extends HttpResponse {
  status: "200";
...
/** List system scan ruleset settings for an account */
export interface SystemScanRulesetSettingsListAlldefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorResponseModel;
}
...
export interface SystemScanRulesetSettingsCreateOrUpdate200Response
  extends HttpResponse {
  status: "200";
  body: SystemScanRulesetSetting;
}
...
/** Creates or Updates a system scan ruleset account settings */
export interface SystemScanRulesetSettingsCreateOrUpdate201Response
  extends HttpResponse {
  status: "201";
  body: SystemScanRulesetSetting;
}
...
/** Creates or Updates a system scan ruleset account settings */
export interface SystemScanRulesetSettingsCreateOrUpdatedefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorResponseModel;
}
